 ...
 */
@WebServlet(name="Arealevel2_insert", urlPatterns={"/film.Arealevel2_insert"})
public class Arealevel2_insert extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IArealevel2Operation.INSERT_AREALEVEL2:
                    insert_arealevel2(arealevel2usecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void insert_arealevel2(Arealevel2_usecases arealevel2usecases) throws CustomException {
