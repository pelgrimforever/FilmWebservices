 ...
 */
@WebServlet(name="Filmsubjects_insert", urlPatterns={"/film.Filmsubjects_insert"})
public class Filmsubjects_insert extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IFilmsubjectsOperation.INSERT_FILMSUBJECTS:
                    insert_filmsubjects(filmsubjectsusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void insert_filmsubjects(Filmsubjects_usecases filmsubjectsusecases) throws CustomException {
        IFilmsubjects filmsubjects = (IFilmsubjects)parser.getJavaObject("filmsubjects");
        filmsubjectsusecases.secureinsertFilmsubjects(filmsubjects);
    }
