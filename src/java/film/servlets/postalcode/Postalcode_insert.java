 ...
 */
@WebServlet(name="Postalcode_insert", urlPatterns={"/film.Postalcode_insert"})
public class Postalcode_insert extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IPostalcodeOperation.INSERT_POSTALCODE:
                    insert_postalcode(postalcodeusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void insert_postalcode(Postalcode_usecases postalcodeusecases) throws CustomException {
        IPostalcode postalcode = (IPostalcode)parser.getJavaObject("postalcode");
        postalcodeusecases.secureinsertPostalcode(postalcode);
    }
