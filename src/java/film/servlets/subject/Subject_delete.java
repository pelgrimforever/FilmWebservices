 ...
 */
@WebServlet(name="Subject_delete", urlPatterns={"/film.Subject_delete"})
public class Subject_delete extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case ISubjectOperation.DELETE_SUBJECT:
                    delete_subject(subjectusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void delete_subject(Subject_usecases subjectusecases) throws CustomException {
        ISubject subject = (ISubject)parser.getJavaObject("subject");
        subjectusecases.securedeleteSubject(subject);
    }
