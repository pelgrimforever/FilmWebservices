 ...
 */
@WebServlet(name="Country_delete", urlPatterns={"/film.Country_delete"})
public class Country_delete extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case ICountryOperation.DELETE_COUNTRY:
                    delete_country(countryusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void delete_country(Country_usecases countryusecases) throws CustomException {
        ICountry country = (ICountry)parser.getJavaObject("country");
        countryusecases.securedeleteCountry(country);
    }
