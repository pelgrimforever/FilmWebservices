 ...
 */
@WebServlet(name="Creator_delete", urlPatterns={"/film.Creator_delete"})
public class Creator_delete extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case ICreatorOperation.DELETE_CREATOR:
                    delete_creator(creatorusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void delete_creator(Creator_usecases creatorusecases) throws CustomException {
        ICreator creator = (ICreator)parser.getJavaObject("creator");
        creatorusecases.securedeleteCreator(creator);
    }
