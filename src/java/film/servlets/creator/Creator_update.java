...
@WebServlet(name="Creator_update", urlPatterns={"/film.Creator_update"})
public class Creator_update extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case ICreatorOperation.UPDATE_CREATOR:
                    update_creator(creatorusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void update_creator(Creator_usecases creatorusecases) throws CustomException {
