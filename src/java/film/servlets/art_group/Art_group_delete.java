 ...
 */
@WebServlet(name="Art_group_delete", urlPatterns={"/film.Art_group_delete"})
public class Art_group_delete extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IArt_groupOperation.DELETE_ART_GROUP:
                    delete_art_group(art_groupusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
