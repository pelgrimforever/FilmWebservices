 ...
 */
@WebServlet(name="Art_group_update", urlPatterns={"/film.Art_group_update"})
public class Art_group_update extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IArt_groupOperation.UPDATE_ART_GROUP:
                    update_art_group(art_groupusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void update_art_group(Art_group_usecases art_groupusecases) throws CustomException {
        IArt_group art_group = (IArt_group)parser.getJavaObject("art_group");
        art_groupusecases.secureupdateArt_group(art_group);
    }
