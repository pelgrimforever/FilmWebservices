 ...
 */
@WebServlet(name="Arealevel3_insert", urlPatterns={"/film.Arealevel3_insert"})
public class Arealevel3_insert extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IArealevel3Operation.INSERT_AREALEVEL3:
                    insert_arealevel3(arealevel3usecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void insert_arealevel3(Arealevel3_usecases arealevel3usecases) throws CustomException {
