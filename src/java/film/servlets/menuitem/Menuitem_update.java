 ...
 */
@WebServlet(name="Menuitem_update", urlPatterns={"/film.Menuitem_update"})
public class Menuitem_update extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IMenuitemOperation.UPDATE_MENUITEM:
                    update_menuitem(menuitemusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void update_menuitem(Menuitem_usecases menuitemusecases) throws CustomException {
        IMenuitem menuitem = (IMenuitem)parser.getJavaObject("menuitem");
        menuitemusecases.secureupdateMenuitem(menuitem);
    }
