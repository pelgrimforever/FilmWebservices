 ...
 */
@WebServlet(name="Subjectcat_delete", urlPatterns={"/film.Subjectcat_delete"})
public class Subjectcat_delete extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case ISubjectcatOperation.DELETE_SUBJECTCAT:
                    delete_subjectcat(subjectcatusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void delete_subjectcat(Subjectcat_usecases subjectcatusecases) throws CustomException {
