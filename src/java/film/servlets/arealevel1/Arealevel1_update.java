 ...
 */
@WebServlet(name="Arealevel1_update", urlPatterns={"/film.Arealevel1_update"})
public class Arealevel1_update extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IArealevel1Operation.UPDATE_AREALEVEL1:
                    update_arealevel1(arealevel1usecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void update_arealevel1(Arealevel1_usecases arealevel1usecases) throws CustomException {
        IArealevel1 arealevel1 = (IArealevel1)parser.getJavaObject("arealevel1");
        arealevel1usecases.secureupdateArealevel1(arealevel1);
    }
