 ...
 */
@WebServlet(name="View_countryphotocount", urlPatterns={"/film.View_countryphotocount"})
public class View_countryphotocount extends SecurityDataServlet {
                ...
                case DataServlet.OPERATIONTYPE_SELECT:
                    switch(this.operation) {
                        case IView_countryphotocountOperation.SELECT_ALL:
                            dataobject = blview_countryphotocount.getView_countryphotocounts();
                            break;
                    }
                    break;
            }
