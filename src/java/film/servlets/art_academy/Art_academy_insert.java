 ...
 */
@WebServlet(name="Art_academy_insert", urlPatterns={"/film.Art_academy_insert"})
public class Art_academy_insert extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IArt_academyOperation.INSERT_ART_ACADEMY:
                    insert_art_academy(art_academyusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void insert_art_academy(Art_academy_usecases art_academyusecases) throws CustomException {
        IArt_academy art_academy = (IArt_academy)parser.getJavaObject("art_academy");
        art_academyusecases.secureinsertArt_academy(art_academy);
    }
