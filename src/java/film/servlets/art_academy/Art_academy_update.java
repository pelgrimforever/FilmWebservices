 ...
 */
@WebServlet(name="Art_academy_update", urlPatterns={"/film.Art_academy_update"})
public class Art_academy_update extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IArt_academyOperation.UPDATE_ART_ACADEMY:
                    update_art_academy(art_academyusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void update_art_academy(Art_academy_usecases art_academyusecases) throws CustomException {
