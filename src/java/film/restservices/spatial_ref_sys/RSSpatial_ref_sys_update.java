 ...
 */
@Path("rsspatial_ref_sys_update")
public class RSSpatial_ref_sys_update extends RS_json_login {
...
//Custom code, do not change this line   
    ...
    private void update_spatial_ref_sys(Spatial_ref_sys_usecases spatial_ref_sysusecases, JSONObject json) throws ParseException, CustomException {
        ...
        spatial_ref_sysusecases.secureupdateSpatial_ref_sys(spatial_ref_sys);
        setReturnstatus("OK");
    }
}
