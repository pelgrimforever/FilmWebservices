...
public class EMview_publiclocalityphotocount_default implements filmDatabaseproperties, ViewMapper {
    ...
    @Override
    public String getTable() { return "view_publiclocalityphotocount"; }
